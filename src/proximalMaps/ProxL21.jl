...
"""
function prox!(::L21Regularization, x::Vector{Tc},λ::T; slices::Int64=1, kargs...) where {T, Tc <: Union{T, Complex{T}}}
...
"""
function norm(::L21Regularization, x::Vector{Tc}, λ::T; slices::Int64=1, kargs...) where {T, Tc <: Union{T, Complex{T}}}
  sliceLength = div(length(x),slices)
  groupNorm = [norm(x[i:sliceLength:end]) for i=1:sliceLength]
